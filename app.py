...
#     api_key = 'AIzaSyDYubD1eIFboU1DGMoAA-6R8zurxwiOz_A'
...
def generate_gemini_response(input_text):
    api_key = 'AIzaSyDYubD1eIFboU1DGMoAA-6R8zurxwiOz_A'
    genai.configure(api_key='AIzaSyDYubD1eIFboU1DGMoAA-6R8zurxwiOz_A')
    model = genai.GenerativeModel('gemini-pro')
    try:
        response = model.generate_content(input_text)
        # Gemini AI SDK already returns the response, no need to check status code
